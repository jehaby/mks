...
class AdminSecurityController extends Controller
{
    ...
    {
        // Это копия метода loginAction из Sonata\UserBundle\Controller\AdminSecurityController (v3.5.0)
        // Добавлена только передача параметра `target_path`` в шаблон формы.
        $user = $this->getUser();
